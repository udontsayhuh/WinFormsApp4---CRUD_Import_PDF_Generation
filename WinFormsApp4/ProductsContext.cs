...
{
    public class ProductsContext : DbContext // DbContext to be inherited by ProductsContext class
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder) //data seed
        {
